const Works = [
...

  {
    ...
    desc:
      "Find the near suya/asun spot in a location, view their menus, check reviews and also drop a review. Frontend uilt with HTML, CSS, BootStrap and Js. Back-end built with NodeJs, Express and MongoDB.",
