...
const showProjects = (sp) => {
    project = ` <div class="col-md-3 p-4">
                        ...
                        <div>
                            <span>
                                <a href=${sp.github} class="text-light float-left ml-5"><i class="fab fa-github-alt" style="font-size: 2rem;" target="blank"></i></a>
                            </span>
                            <span>
                                <a href=${sp.url} class="text-light float-right mr-5"><i class="fas fa-external-link-square-alt" style="font-size: 2rem;" target="blank"></i></a>
                            </span>
                        </div>
