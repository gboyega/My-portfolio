...
const showProjects = (sp) => {
    project = ` <div class="col-md-3 p-4">
                        ...
                        <a href=${sp.url}><h4 class="text-center text-break text-light mt-2">${sp.title}</h4><a
                        ...
                        <div>
                            ...
                            <span>
                                <a href= class="text-light float-right mr-5" target="blank"><i class="fas fa-external-link-square-alt" style="font-size: 2rem;"></i></a>
                            </span>
                        </div>
