...
const showProjects = sp => {
  ...
  <div class="card-body">
    <a href=${sp.github} class="text-success card-link" target="blank"><i class="fab fa-github-alt"></i>Repo</a>
    <a href=${sp.url} class="text-succe card-link" target="blank"><i class="fab fa-github-alt"></i>Website</a>
  </div>
</div>`;
  document
