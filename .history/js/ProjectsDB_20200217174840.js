const Works = [
...

  {
    ...
    desc:
      "A site that helps find suya/asun spot in a location, view their menus, check reviews and also drop a review. Frontend uilt with HTML, CSS, BootStrap and Js. Back-end built with NodeJs, Express ",
