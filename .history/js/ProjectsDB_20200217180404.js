const Works = [
...

  {
    ...
    desc:
      "Find the nearest suya/asun spot in your location, view their menus, check reviews and also drop a review. Frontend built with HTML, CSS, BootStrap and Javs. Back-end built with NodeJs, Express and MongoDB.",
