...
const showProjects = sp => {
  ...
  <div class="card-footer">
    <a href=${sp.github} class="text-info text-start card-link" target="blank"><i class="fab fa-github-alt"></i>Repo</a>
    <a href=${sp.url} class="text-info text-end card-link" target="blank"><i class="fab fa-github-alt"></i>Website</a>
  </div>
  </div>
</div>`;
  document
